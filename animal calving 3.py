...
# Step 2: Fetch data from db1 one row at a time
...
# Step 3: Train the ML model using accumulated data
...
def main():
    ...
    # Step 2: Fetch the data from db1 (one row at a time)
    data_from_db1 = fetch_data_from_db1()
    
    if data_from_db1:
        # Step 3: Train the ML model with the fetched data
